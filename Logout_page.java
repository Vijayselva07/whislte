...
public class Logout_page {
	...
	public void tc1() throws MalformedURLException, InterruptedException {
		...
		log.click();
		Thread.sleep(2000);
		MobileElement log1 = driver.findElement(By.xpath("//android.widget.TextView[@text=\"\"]"));
		log1.click();
		Thread.sleep(2000);
		MobileElement log2 = driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Logout\"]"));
		log2.click();
